						...
						<div class="col-xl-12 col-xxl-12 col-lg-12 col-md-12">
								<div class="card">
									<div class="card-header border-0 pb-0">
										<h4 class="card-title"  style="font-size: 27px;">Admin Details</h4>
									</div>
									<div class="card-body">
                                        ...
                                        <thead>
                                            ...
                                            <tr>                                               
                                               ...
                                               <td>                                                   
                                                ...
                                                <td>   <?php echo $detail->user_count; ?> </td>
                                                 
                                                <td>                                              
                                                    <div class="d-flex">                                                      
                                                        <form class="blog_delete" action="<?php echo base_url('superadmin/delete_user/'.$detail->id); ?>" method="POST" style="float: left;">
