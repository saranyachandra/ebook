        ...
        <section>
          ...
          <div class="region region-content">
            <div class="clearfix bs-home">
              <div class="bs-region--slider clearfix">
                <div class="col-xs-12">
                  <div class="block-region-slider">
                    <section
                      class="block-content-bundle-slider block block-block-content block-block-content0e413ca1-228a-4c10-8634-becf01039e4c clearfix">
                      <div class="block-header">
                      </div>
                      <div class="block-content">
                        <div
                          class="mn-field-slider field field--name-field-slide field--type-entity-reference-revisions field--label-hidden field--items">
                          <div class="field--item">
                            <div style="background:url(<?php echo base_url();?>assets/web/images/01.jpg)"
                              class="paragraph paragraph--type--main-slide paragraph--view-mode--default">
                              <div
                                class="field field--name-field-title field--type-string field--label-hidden field--item">
                                LOTS OF EBOOKS. 100 % FREE</div>
                              <div
                                class="field field--name-field-description field--type-text-long field--label-hidden field--item">
                                <p>Welcome to your friendly neighborhood library. We have more than 50,000 free ebooks
                                  waiting to be discovered.</p>
                              </div>
                            </div>
                          </div>
                          <div class="field--item">
                            <div style="background:url(<?php echo base_url();?>assets/web/images/02.jpg)"
                              class="paragraph paragraph--type--main-slide paragraph--view-mode--default">
                              <div
                                class="field field--name-field-title field--type-string field--label-hidden field--item">
                                FREE AND DISCOUNTED BESTSELLERS</div>
                              <div
                                class="field field--name-field-description field--type-text-long field--label-hidden field--item">
                                <p>Join 150,000+ fellow readers. Get free and discounted bestsellers straight to your
                                  inbox with the ManyBooks eBook deals newsletter. <a
                                    href="#http://newsletter.manybooks.net/lp/">Signup now</a></p>
                              </div>
                          ...
                          <div class="field--item">
                            <div style="background:url(<?php echo base_url();?>assets/web/images/01.jpg)"
                              ...
                              <div
                                class="field field--name-field-title field--type-string field--label-hidden field--item">
                                The Ultimate Guide to Free eBooks</div>
                              <div
                                class="field field--name-field-description field--type-text-long field--label-hidden field--item">
                                <p>Not sure what to read next? Explore our catalog of public domain books with our
                                  editors. Some real gems are hidden in our library. <a
                                    href="#articles/best-free-ebooks-guide.html">Read more</a></p>
                              </div>
                            </div>
                          </div>
                        </div>
              ...
              <div class="bs-region--top-main">
                <div class="container">
                  <div class="row">
                    <div class="bs-region bs-region--top-main">
                      <div class="block-region-top-main">
                        <section
                          class="block-content-bundle-grid block block-block-content block-block-content4d2bc638-b8b9-4342-b54a-24abaad680ba clearfix">
                          <div class="block-header">
                          ...
                          <div class="block-content">
                            <div
                              class="row field field--name-field-grid-item field--type-entity-reference-revisions field--label-hidden field--items">
                              <div class="col-xs-6 col-sm-6 col-md-4 col-lg-4 field--item">
                                <div class="paragraph paragraph--type--simple-grid-item paragraph--view-mode--default">
                                  <div
                                    class="field field--name-field-image field--type-image field--label-hidden field--item">
                                    <img
                                      src="<?php echo base_url('assets/web/images/socail-work.jpg');?>"
                                      width="465" height="295" alt="" typeof="foaf:Image" class="img-responsive" />
                                  </div>
                                  <div
                                    class="field field--name-field-link field--type-link field--label-hidden field--item">
                                    <div class="form-group"><span>Social Work</span>
                                      <a href="<?php echo base_url('web/filter_ebook/'.'Social Work');?>"></a>
                                    </div>
                                  </div>
                                </div>
                              </div>
                              <div class="col-xs-6 col-sm-6 col-md-4 col-lg-4 field--item">
                                <div class="paragraph paragraph--type--simple-grid-item paragraph--view-mode--default">
                                  <div
                                    class="field field--name-field-image field--type-image field--label-hidden field--item">
                                    <img
                                      src="<?php echo base_url('assets/web/images/fisheres.jpg');?>"
                                      width="465" height="295" alt="" typeof="foaf:Image" class="img-responsive" />
                                  </div>
                                  <div
                                    class="field field--name-field-link field--type-link field--label-hidden field--item">
                                    <div class="form-group"><span>Fisheries</span>
                                      <a href="<?php echo base_url('web/filter_ebook/'.'Fisheries');?>"></a>
                                    </div>
                                  </div>
                                </div>
                              </div>
                              <div class="col-xs-6 col-sm-6 col-md-4 col-lg-4 field--item">
                                <div class="paragraph paragraph--type--simple-grid-item paragraph--view-mode--default">
                                  <div
                                    class="field field--name-field-image field--type-image field--label-hidden field--item">
                                    <img
                                      src="<?php echo base_url('assets/web/images/sel-improment.jpg');?>"
                                      width="465" height="295" alt="" typeof="foaf:Image" class="img-responsive" />
                                  </div>
                                  <div
                                    class="field field--name-field-link field--type-link field--label-hidden field--item">
                                    <div class="form-group"><span>Seff Improvement</span>
                                      <a href="<?php echo base_url('web/filter_ebook/'.'Seff Improvement');?>"></a>
                                    </div>
                                  </div>
                                </div>
                              </div>
                              <div class="col-xs-6 col-sm-6 col-md-4 col-lg-4 field--item">
                                <div class="paragraph paragraph--type--simple-grid-item paragraph--view-mode--default">
                                  <div
                                    class="field field--name-field-image field--type-image field--label-hidden field--item">
                                    <img
                                      src="<?php echo base_url('assets/web/images/Electronics.jpg');?>"
                                      width="465" height="295" alt="" typeof="foaf:Image" class="img-responsive" />
                                  </div>
                                  <div
                                    class="field field--name-field-link field--type-link field--label-hidden field--item">
                                    <div class="form-group"><span>Electronics</span>
                                      <a href="<?php echo base_url('web/filter_ebook/'.'Electronics');?>"></a>
                                    </div>
                                  </div>
                                </div>
                              </div>
                              <div class="col-xs-6 col-sm-6 col-md-4 col-lg-4 field--item">
                                <div class="paragraph paragraph--type--simple-grid-item paragraph--view-mode--default">
                                  <div
                                    class="field field--name-field-image field--type-image field--label-hidden field--item">
                                    <img
                                      src="<?php echo base_url('assets/web/images/english.jpg');?>"
                                      width="465" height="295" alt="" typeof="foaf:Image" class="img-responsive" />
                                  </div>
                                  <div
                                    class="field field--name-field-link field--type-link field--label-hidden field--item">
                                    <div class="form-group"><span>English</span>
                                       <a href="<?php echo base_url('web/filter_ebook/'.'English');?>"></a>
                                    </div>
                                  </div>
                                </div>
                              </div>
                              <div class="col-xs-6 col-sm-6 col-md-4 col-lg-4 field--item">
                                <div class="paragraph paragraph--type--simple-grid-item paragraph--view-mode--default">
                                  <div
                                    class="field field--name-field-image field--type-image field--label-hidden field--item">
                                    <img
                                      src="<?php echo base_url('assets/web/images/management.jpg');?>"
                                      width="465" height="295" alt="" typeof="foaf:Image" class="img-responsive" />
                                  </div>
                                  <div
                                    class="field field--name-field-link field--type-link field--label-hidden field--item">
                                    <div class="form-group"><span>Management</span>
                                       <a href="<?php echo base_url('web/filter_ebook/'.'Management');?>"></a>
                                    </div>
                                  </div>
                                </div>
                              </div>
                  ...
                  <div class="row">
                    <div class="col-xs-12">
                      <div class="block-region-top-center">
                        <section
                          class="views-element-container block block-views block-views-blockbooks-block-editor-choice clearfix">
                          <div class="block-header">
                            <h2 class="block-title">Editor's choice</h2>
                            <a href="##">(view all)</a>
                          </div>
                          <div class="block-content">
                            <div class="form-group">
                              <div
                                class="editors-choice-block view view-books view-id-books view-display-id-block_editor_choice js-view-dom-id-d20242c584cbcc67a091d3c01b6a41f6b2d76d30218fe28443e5585e7af400b3">
                                <div class="view-content">
                                  ...
                                  ?>
                                  <div class="views-row">
                                    <article data-history-node-id="249201" role="article"
                                      about="/titles/disciple-of-vengeance"
                                        ...
                                        <div class="field field--name-field-cover field--type-image field--label-hidden field--item">
                                          <a href="##" hreflang="en">
                                            <img src="<?php echo base_url('assets/admin/uploads/ebook_thumb/'.$detail->img);?>"
                                              width="220" height="330" alt="Disciple of Vengeance by CC Rasmussen"
                                      ...
                                      <div class="book-hover">
                                        <div class="image">
                                          <div
                                            ...
                                            <a href="##" hreflang="en"><img
                                                src="<?php echo base_url('assets/admin/uploads/ebook_thumb/'.$detail->img);?>"
                                                width="220" height="330" alt="Disciple of Vengeance by CC Rasmussen"
                                                typeof="foaf:Image" class="img-responsive" />
                                            </a>
                                          </div>
                                        ...
                                        <div class="book-hover-content">
                                          ...
                                          <span>by
                                            <div
                                              ...
                                              <div class="field--item"><a href="##"
                                                  hreflang="en"><?=$detail->author_name;?></a></div>
                                            </div>
                                          </span>
                                          ...
                                          <?php } ?>
                                          <!--<a href="#" class="book-hover-read">Read more</a>-->
                                        </div>
                                      </div>
                                    </article>
                                  </div>
                        ...
                        <section
                          ...
                          <div class="block-header">
                            <h2 class="block-title">Trending books</h2>
                            <a href="#">(view all)</a>
                          </div>
                          <div class="block-content">
                            <div class="form-group">
