							...
							<div class="col-xl-4 col-xxl-4 col-lg-6 col-sm-6">
								<div class="card overflow-hidden">
									<div class="card-body pb-0 px-4 pt-4">
										<div class="row">
											<div class="col">
												<h5 class="mb-1"><?php echo $stu_count->total_stu; ?></h5>
												<span class="text-success">Total Student</span>
											</div>
										</div>
									</div>
							...
							<div class="col-xl-4 col-xxl-4 col-lg-6 col-sm-6">
								<div class="card bg-success	overflow-hidden">
									<div class="card-body pb-0 px-4 pt-4">
										<div class="row">
											<div class="col">
												<h5 class="text-white mb-1"><?php echo $act_count->act_stu; ?></h5>
									...
									<div class="card-body pb-0 px-4 pt-4">
										<div class="row">
											<div class="col text-white">
												<h5 class="text-white mb-1"><?php echo $user_count_val; ?></h5>
												<span>Allocated std count</span>
											</div>
										</div>
									</div>
